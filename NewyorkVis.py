...
icon_href = 'noun_metro_368056.png'
os.path.normpath(icon_href)
metro_icon = folium.plugins.BeautifyIcon(icon=icon_href)
...
icon =folium.features.CustomIcon(icon_image=icon_href,icon_size=(30,30),icon_anchor=(10,10),popup_anchor=(-3, -76))
...
sf = os.path.join('html','mapdouble001.html')
#folium_map.save(sf)
